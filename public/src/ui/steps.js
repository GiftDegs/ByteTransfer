  ...
  return `
    <div class="mt-4 w-full">
      <div class="rounded-2xl border border-white/40 dark:border-white/10 bg-white/55 dark:bg-white/10 backdrop-blur-md shadow-sm px-4 py-3">
        ...
        <div class="mt-1 text-sm font-semibold text-gray-700 dark:text-gray-200 text-center">
          ${fecha}
        </div>
...
function metaCardEquivalente({ usdFmt }) {
  if (!usdFmt) return "";
  ...
  return `
    <div class="mt-3 w-full">
      <div class="rounded-2xl border border-white/40 dark:border-white/10 bg-white/55 dark:bg-white/10 backdrop-blur-md shadow-sm px-4 py-3">
        ...
        <div class="mt-1 text-[12px] text-gray-600 dark:text-gray-300 italic text-center">
          según tasa BCV
        </div>
      </div>
    </div>
